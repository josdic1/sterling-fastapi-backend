# scripts/add_all_families.py
#!/usr/bin/env python3
"""
Seed/reset script: Add family members for specific users.

WARNING:
- This DELETES existing members for those users and recreates them.
- This is NOT a migration. Do not auto-run on deploy.
"""
    ...
    try:
        ...
        families = [
                ...
                "members": [
                    {
                        "name": "Josh Dicker",
                        "relation": "self",
                        "dietary": "NO shellfish, pork, blue cheese",
                    },
                    {
                        "name": "Dorrie Goodman",
                        "relation": "spouse",
                        "dietary": "NO olives, blue cheese",
                    },
            ...
            },
            {
                ...
                "members": [{"name": "Sarah Scott", "relation": "self", "dietary": "NO bananas"}],
            },
            {
                "email": "jaime@jaime.com",
                "members": [{"name": "Jaime Aker", "relation": "self", "dietary": None}],
            },
            {
                "email": "brian@brian.com",
                "members": [{"name": "Brian Kaiser", "relation": "self", "dietary": "NO fish"}],
            },
        ]
        ...
        for family in families:
            ...
            for member_data in family["members"]:
                ...
                db.add(member)
                dietary_text = member_data["dietary"] or "No restrictions"
